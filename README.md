...
Built as a production-style **modular monolith** (Java 21, Spring Boot 3) - designed to demonstrate backend engineering: system design, event-driven architecture, RAG, and provider-agnostic integrations.
